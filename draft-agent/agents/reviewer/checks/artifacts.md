...
The final artifact should not accidentally include internal Draft Agent state such as:
...
`.draft/` state belongs to the workflow, not normally to the deliverable.

...
This registry is the canonical index of reusable writing standards available to Draft Agent.
...
Task-specific writing requirements belong in:

`.draft/<artifact-name>/requirements.md`

Task-specific grounded content belongs in the schema:

`.draft/<artifact-name>/schema.md`

...
| Grounding fidelity | Not reviewed | — | — | — | grounding.md | — |
| Authoring authority | Not reviewed | — | — | — | authority.md | — |
...
- Every `Drift` row must identify the requirement, grounded content, authoring decision, reviewer check, or writing standard that governs the finding.

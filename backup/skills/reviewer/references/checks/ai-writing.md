...
If necessary substance is missing and the artifact cannot be completed under the current authoring authority, return the unresolved need through the Authoring Contract. Use Content Grounding when additional factual evidence or source-backed content is required.
